...
CUDA_VISIBLE_DEVICES=6 nohup python generate.py  --model_path "//workspace/SimCTG/story_generation/simctg_cnndm_bsz16/training_step_29000_train_mle_loss_2.894_train_cl_loss_0.003_dev_ppl_17.303" \
--gen_dir "generated_texts/simctg_cnndm/bsz16" --prefix "" &> gen_cnndm_bsz16.out &
